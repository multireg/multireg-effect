...
def main():
    ...
    parser.add_argument("--logfile", type=str,help="name of the logfile",default='./log_rnn.out')
    ...
    parser.add_argument("--hs1", type=int,help="hidden size",default=512)
    parser.add_argument("--hs2", type=int,help="hidden size",default=256)    
    parser.add_argument("--layer_num", type=int,help="number of layers in lstm",default=1)
    parser.add_argument("--dense_out", type=int,help="dimension of dense layer",default=256)
