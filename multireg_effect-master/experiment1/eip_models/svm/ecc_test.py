...
def apply_ecc_test(predictions,stoi,data,emotion_words,args):
...
def race_gender_score(emotion_words,merged,male_names,female_names,male_noun_phrases,female_noun_phrases,af_names,eu_names):
    ...
    for template in templates_wo_emotion:
        ...
        gender_scores_wo_emotion.append(score_gender) # There is a 11 score here for that template 
...
def apply_ecc_test_age(predictions,stoi,data,emotion_words,old_names,young_names,args):
